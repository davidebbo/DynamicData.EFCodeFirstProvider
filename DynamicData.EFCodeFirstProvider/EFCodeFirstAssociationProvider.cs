...
namespace DynamicData.EFCodeFirstProvider {
    internal sealed class EFCodeFirstAssociationProvider : AssociationProvider {
        ...
        internal static long BuildRelationshipKey(EntityType entityType, RelationshipEndMember member) {
            return HashCodeCombiner.CombineHashCodes(entityType.GetHashCode(), member.GetHashCode());
        }
